...
class RevisedHerbivory: public EatingImplementation {
    ...
    std::vector< std::vector <double> > BiomassesEaten;
    ...
    std::vector< std::vector <double> > PotentialBiomassesEaten;
    ...
    void GetEatingPotentialTerrestrial( GridCell& gcl, Cohort& actingCohort, MadingleyInitialisation& params ) {
        ...
        for( int FunctionalGroup: mFunctionalGroupIndicesToEat ) {
            ...
            for( int i = 0; i < gcl.mStocks[FunctionalGroup].size( ); i++ ) {
                ...
                EdibleMass = gcl.mStocks[FunctionalGroup][i].mTotalBiomass * 0.1;
    ...
    void GetEatingPotentialMarine( GridCell& gcl, Cohort& actingCohort, MadingleyInitialisation& params ) {
        ...
        for( int FunctionalGroup: mFunctionalGroupIndicesToEat ) {
            ...
            for( int i = 0; i < gcl.mStocks[FunctionalGroup].size( ); i++ ) {
                ...
                EdibleMass = gcl.mStocks[FunctionalGroup][i].mTotalBiomass;
                // Calculate the potential biomass eaten from this stock by the acting cohort
    ...
    void RunEating( GridCell& gcl, Cohort& actingCohort,
        ...
        for( int FunctionalGroup: mFunctionalGroupIndicesToEat ) {
            ...
            for( int i = 0; i < gcl.mStocks[FunctionalGroup].size( ); i++ ) {
                ...
                EdibleMass = gcl.mStocks[FunctionalGroup][i].mTotalBiomass * EdibleScaling;
                ...
                gcl.mStocks[FunctionalGroup][i].mTotalBiomass -= BiomassesEaten[FunctionalGroup][i];
