...
class EatingImplementation {
public:
    EatingImplementation( ) {
        ;
    }

    EatingImplementation( string globalModelTimeStepUnit ) {
        cout << "Virtual IEatingImplementation constructor called:This is probably a mistake" << endl;
    }

    virtual ~EatingImplementation( ) {
        ;
    }
