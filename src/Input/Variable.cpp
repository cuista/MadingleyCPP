...
Variable::Variable( const std::string& name, const Types::UnsignedIntegerVector& dimensions, const unsigned int& size, float* data, const bool isDefault ) {
    mName = name;
...
Types::UnsignedIntegerVector Variable::GetDimensions( ) const {
    return mDimensions;
}
